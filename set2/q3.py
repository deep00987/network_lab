...
print("\n\n========= Output =========\n\n")
print("----------------|-----------------------|-----------------------|-----------------------|-----------------------|\t")
print("Source IP\t|\tDestination IP\t|\tProtocol\t|\tNo of segments\t|\tAvg payload len |\t")
print("----------------|-----------------------|-----------------------|-----------------------|-----------------------|\t")

for key in pkt_info_dict:
    print(f"{key[0]}\t|\t{key[1]}\t|\t{'TCP'if pkt_info_dict[key]['TCP'] > 0 else 'UDP' }\t\t|\t{pkt_info_dict[key]['segments']}\t\t|\t{pkt_info_dict[key]['total_length'] // pkt_info_dict[key]['segments']}\t\t|\t")
